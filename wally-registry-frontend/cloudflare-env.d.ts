// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 08353dc50009454f1b6eefe28f9b19e9)
// Runtime types generated with workerd@1.20250409.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_WALLY_API_URL: "https://api.wally.run" | "https://api.test.wally.run";
		NEXTJS_ENV: string;
	}
}
